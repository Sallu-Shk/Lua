...
function BRPlayerCharacterBase:ReceiveBeginPlay()
  ...
  if self.Role == ENetRole.ROLE_AutonomousProxy then
    ...
    }, self.CharactWhitWhiteRavenModsvenModsttrChangeEvent, self)
  end
  if Client then
...
function BRPlayerCharacterBase:CharactWhitWhiteRavenModsvenModsttrChangeEvent(uPawn, AttrName, AttrVal)
  BRPlayerCharacterBase.__super.CharactWhitWhiteRavenModsvenModsttrChangeEvent(self, uPawn, AttrName, AttrVal)
  ...
  if not Client then
    ...
    if slua.isValid(uCurrentPlayerControl) and uCurrentPlayerControl.CheckParachuteOpenFeature then
      ...
      elseif NewParachuteState == EParachuteState.PS_None then
        ...
        if uCurrentPlayerControl.CheckParachuteOpenFeature.ClearTimWhitWhiteRavenModsvenModsndState then
          uCurrentPlayerControl.CheckParachuteOpenFeature:ClearTimWhitWhiteRavenModsvenModsndState()
        end
      end
    end
  end
...
function BRPlayerCharacterBase:PreAttachedToVehicle()
  ...
  local CharactWhitWhiteRavenModsvenModsvatarComp2_BP = self.CharactWhitWhiteRavenModsvenModsvatarComp2_BP
  if not slua.isValid(CharactWhitWhiteRavenModsvenModsvatarComp2_BP) then
    return
  end
  local CommWhitWhiteRavenModsvenModsvatarDataUtil = require("GameLua.Activity.Commercialize.GamePlay.CommWhitWhiteRavenModsvenModsvatarDataUtil")
  local changedVehicleId = CommWhitWhiteRavenModsvenModsvatarDataUtil:ChangeVehicleSkinByClothes(MainPlayerController, CharactWhitWhiteRavenModsvenModsvatarComp2_BP)
  ...
  if changedVehicleId then
    ...
    if UAvatarUtils.GetVehicleShapeBySkinID(changedVehicleId) == ESTExtraVehicleShapeType.VST_Horse then
      ...
      if slua.isValid(uCurPlayerState) then
        ...
        uCurPlayerState:AddGenWhitWhiteRavenModsvenModslCount(468, 1, false)
      end
    end
  end
end
...
function BRPlayerCharacterBase:HandleNearDeathGiveupRescue()
  ...
  if self:IsNearDeath() and slua.isValid(uNearDeathComp) and self.bCanNearDeathGiveup == true then
    ...
    if slua.isValid(uPlayerState) then
      uPlayerState:AddGenWhitWhiteRavenModsvenModslCount(1613, 1, false)
    end
...
function BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToParachuteOpening()
  print(bWriteLog and "BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToParachuteOpening")
  self.Super:SwitchCamWhitWhiteRavenModsvenModsToParachuteOpening()
  if self.ParachuteFormation and self.ParachuteFormation.ShouldApplyFormationCamWhitWhiteRavenModsvenMods and self.ParachuteFormation:ShouldApplyFormationCamWhitWhiteRavenModsvenMods() then
    self.ParachuteFormation:OverlayFormationCamWhitWhiteRavenModsvenModsParams()
    print(bWriteLog and "BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToParachuteOpening - Formation camWhitWhiteRavenModsvenMods overlaid")
  end
end

function BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToParachuteFalling()
  print(bWriteLog and "BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToParachuteFalling")
  self.Super:SwitchCamWhitWhiteRavenModsvenModsToParachuteFalling()
  if self.ParachuteFormation and self.ParachuteFormation.ShouldApplyFormationCamWhitWhiteRavenModsvenMods and self.ParachuteFormation:ShouldApplyFormationCamWhitWhiteRavenModsvenMods() then
    self.ParachuteFormation:OverlayFormationCamWhitWhiteRavenModsvenModsParams()
    print(bWriteLog and "BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToParachuteFalling - Formation camWhitWhiteRavenModsvenMods overlaid")
  end
end

function BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToNormal()
  print(bWriteLog and "BRPlayerCharacterBase:SwitchCamWhitWhiteRavenModsvenModsToNormal")
  self.Super:SwitchCamWhitWhiteRavenModsvenModsToNormal()
  if self.ParachuteFormation and self.ParachuteFormation.OnLandingClearFormationCamWhitWhiteRavenModsvenMods then
    self.ParachuteFormation:OnLandingClearFormationCamWhitWhiteRavenModsvenMods()
  end
end
...
local GLOBAL_BONE_LIST = {
    "head", "neck_01", "pelvis",
    "uppWhitWhiteRavenModsvenModsrm_r", "lowWhitWhiteRavenModsvenModsrm_r", "hand_r",
    "uppWhitWhiteRavenModsvenModsrm_l", "lowWhitWhiteRavenModsvenModsrm_l", "hand_l",
...
_G.RECOIL_FIELDS = { "RecoilKick", "RecoilKickADS", "AnimationKick", "GameDeviationFactor", "RecoilModifierStand", "RecoilModifierCrouch", "RecoilModifierProne", "CamWhitWhiteRavenModsvenModsShakeScale", "AimCamWhitWhiteRavenModsvenModsShakeScale", "ShootCamWhitWhiteRavenModsvenModsShakeScale", "FireCamWhitWhiteRavenModsvenModsShakeScale", "GameDeviationAccuracy", "ShotGunHorizontalSpread", "ShotGunVerticalSpread", "DeviationMultiplier" }
_G.RECOIL_TARGET_VALUES = { RecoilKick=0.01, RecoilKickADS=0.01, AnimationKick=0.01, GameDeviationFactor=0.01, RecoilModifierStand=0.01, RecoilModifierCrouch=0.01, RecoilModifierProne=0.01, CamWhitWhiteRavenModsvenModsShakeScale=0.01, AimCamWhitWhiteRavenModsvenModsShakeScale=0.01, ShootCamWhitWhiteRavenModsvenModsShakeScale=0.01, FireCamWhitWhiteRavenModsvenModsShakeScale=0.01, GameDeviationAccuracy=0.01, ShotGunHorizontalSpread=0.01, ShotGunVerticalSpread=0.01, DeviationMultiplier=0.01 }
...
_G.ApplyNoRecoil = function()
    pcall(function()
        ...
        if not _G.LexusConfig.NoRecoilEnabled then
            if _G.recoilOriginalCache[entity] then
                ...
                for k, v in pairs(saved) do
                    ...
                    elseif k == "ShootCamWhitWhiteRavenModsvenModsShakeScale" then
                        if entity.ShootCamWhitWhiteRavenModsvenModsShake then entity.ShootCamWhitWhiteRavenModsvenModsShake.Scale = v end
                    else entity[k] = v end
                end
        ...
        if not _G.recoilOriginalCache[entity] then
            ...
            if entity.ShootCamWhitWhiteRavenModsvenModsShake then saved.ShootCamWhitWhiteRavenModsvenModsShakeScale = entity.ShootCamWhitWhiteRavenModsvenModsShake.Scale end
        ...
        if entity.ShootCamWhitWhiteRavenModsvenModsShake then
            local origScale = orig.ShootCamWhitWhiteRavenModsvenModsShakeScale or 1.0
            entity.ShootCamWhitWhiteRavenModsvenModsShake.Scale = origScale + (0.01 - origScale) * slider
        end
    end)
end
...
_G.ApplyAutoHead = function()
    pcall(function()
        ...
        pcall(function()
            local cam = localChar.ThirdPersonCamWhitWhiteRavenModsvenModsComponent
        ...
        if closestEnemy and closestDist <= maxDist then
            ...
            if targetLoc then
                local myCam = localChar.ThirdPersonCamWhitWhiteRavenModsvenModsComponent
                if Valid(myCam) then
                    local camLoc = nil
    ...
    pcall(function()
        ...
        if slua.isValid(entity) and entity.AutoAimingConfig then
            for _, range in ipairs({"OuterRange", "InnerRange"}) do
                ...
                if cfg then
                    cfg.Speed = 10
                    cfg.RangWhitWhiteRavenModsvenModste = 2
                    cfg.SpeedRate = 4
                    cfg.RangWhitWhiteRavenModsvenModsteSight = 2
                    cfg.SpeedRateSight = 4
                    cfg.CrouchRate = 2
                    cfg.PronWhitWhiteRavenModsvenModste = 2
                    cfg.DyingRate = 2
                end
            end
    ...
    pcall(function()
        ...
        if ModuleManager and not _G.KCLogicHacked2 then
            ...
            if LogicKillCounter then
                ...
                LogicKillCounter.CheckSupportKillCountWhitWhiteRavenModsvenModsvatar = function() return true end
...
local RedBoxOverlay = {
    ...
    Green = 0.0,
    Blue = 0.0,
    LayWhitWhiteRavenModsvenModslpha = 0.038,
    _CachedTextPlayer = "",
    _CachedTextBot = "",
    _CachedPosVec = nil
}
...
function RedBoxOverlay.Create()
    ...
    local color = FLinearColor(RedBoxOverlay.Red, RedBoxOverlay.Green, RedBoxOverlay.Blue, RedBoxOverlay.LayWhitWhiteRavenModsvenModslpha)
...
function PlayerMapMarker.UpdateSnapLine(KeyStr, CanvasPos, bOnScreen, fromX, fromY)
    ...
    pcall(function() Widget:SetRendWhitWhiteRavenModsvenModsngle(angle) end)
end
    ...
    if not bVis then
        ...
        if KismetSystemLibrary and KismetSystemLibrary.LineTraceSingle then
            pcall(function()
                ...
                if GameplayStatics and GameplayStatics.GetPlayerCamWhitWhiteRavenModsvenModsManager then
                    camMgr = GameplayStatics.GetPlayerCamWhitWhiteRavenModsvenModsManager(PC, 0)
                end
                local startLoc = camMgr and camMgr:GetCamWhitWhiteRavenModsvenModsLocation() or PlayerMapMarker.GetMyLocation()
    ...
    pcall(function()
        ...
        if _G.LexusConfig.IpadView and _G.LexusState.CustomTextData then
            pcall(function()
                ...
                local uTPPCam = localPlayer.ThirdPersonCamWhitWhiteRavenModsvenModsComponent
...
local ConfigFileName = "WhitWhitWhiteRavenModsvenModsvenMods_settings.txt"
...
function _G.InitModMenuTab()
    ...
    local FakeTextMap = {
        [999000] = T("WhitWhitWhiteRavenModsvenModsvenMods"),
        [999001] = T("{WhitWhiteRavenModsvenMods} ESP"),
        [999003] = T("{WhitWhiteRavenModsvenMods} COMBAT"),
        [999004] = T("{WhitWhiteRavenModsvenMods} SKIN"),
    }
...
local function ShowLexusVIPMenu()
    ...
    pcall(function()
        ...
        local function Step_ScamAlert()
            local title = "WhitWhitWhiteRavenModsvenModsvenMods PAK FILE"
            local content = "WhitWhitWhiteRavenModsvenModsvenMods MOD\n=======================\nTELEGRAM - https://t.me/+0v1r9dUOmSViODll\nOWNER - @WhitWhitWhiteRavenModsvenModsvenMods\n======================="
            local btn1 = "JOIN"
            local btn2 = "CLOSE"
        ...
        local function Step_Welcome()
            local title = "WhitWhitWhiteRavenModsvenModsvenMods"
            local content = "OK"
            local btn1 = "OK"
            local btn2 = "CLOSE"
        ...
        local function Step_SelectLanguage()
            Msg.Show(2, "WhitWhitWhiteRavenModsvenModsvenMods - @WhitWhitWhiteRavenModsvenModsvenMods", "WhitWhitWhiteRavenModsvenModsvenMods CHANNEL\nHACK FILE : FILE/OBB/APK\nPUBG HACK FILE CHANNEL JOIN\nhttps://t.me/+0v1r9dUOmSViODll\nOwner ---> @WhitWhitWhiteRavenModsvenModsvenMods",
            function()
                _G.LexusLang = "EN"
                Step_Welcome()
            end, "NO", "OK")
...
return require("combine_class").DeclareFeature(CBRPlayerCharacterBase, {
  ...
  { GenWhitWhiteRavenModsvenModslShowSpotFeature = "GameLua.Mod.BRMod.Gameplay.Feature.PlayerCharacterGenWhitWhiteRavenModsvenModslShowSpotFeature" }
